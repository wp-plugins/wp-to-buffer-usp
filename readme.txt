...
Connects the User Submitted Posts Plugin with WP to Buffer, ensuring User Submitted Posts are published to Buffer.
...
1. Upload the `wp-to-buffer-usp` folder to the `/wp-content/plugins/` directory
2. Active the WP to Buffer USP plugin through the 'Plugins' menu in WordPress
